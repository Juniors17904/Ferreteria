...
public final class SplashScreenBinding implements ViewBinding {
  ...
  private SplashScreenBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imageView) {
  ...
  public static SplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SplashScreenBinding((RelativeLayout) rootView, imageView);
    }
